...
<h1>JQuery start</h1>
		...
		<div class="measure_dashboard_content">
					...
					<ul>
						<li><label>HEIGHT</label>
							<div class="measure_value">
								<input type="text"  name="measure_height" class="txt_input" checkRule="required,double" filedName="height" msg="Hight must be a number!" msgField="measure_height_noti">&nbsp;IN
							</div>
				...
				<div class="measure_content">
					<div style="height: 300px;width: 400px;">
						<div class="attribute">
							...
							<h4>SHOULDERS</h4>
							<ul class="options">
								<li><input type="radio" name="measure_shoulders" onclick="changePicAndApplyValue('/style/image/shoulders_square.png','Square Shoulders','measure_shoulders_img','measure_shoulders')" value="Square Shoulders"><label>Square Shoulders</label></li>
								<li><input type="radio" name="measure_shoulders" onclick="changePicAndApplyValue('/style/image/shoulders_normal.png','Normal Shoulders','measure_shoulders_img','measure_shoulders')" value="Normal Shoulders"><label>Normal Shoulders</label></li>
								<li><input type="radio" name="measure_shoulders" onclick="changePicAndApplyValue('/style/image/shoulders_sloping.png','Sloping Shoulders','measure_shoulders_img','measure_shoulders')" value="Sloping Shoulders"><label >Sloping Shoulders</label></li>
							</ul>
						...
						<div class="attribute">
							...
							<h4>CHEST</h4>
							<ul class="options">
								<li><input type="radio" name="measure_chest"  value="Muscular Chest" onclick="changePicAndApplyValue('/style/image/chest_muscular.png','Muscular Chest','measure_chest_ing','measure_chest')"><label>Muscular Chest</label></li>
								<li><input type="radio" name="measure_chest"  value="Regular Chest" onclick="changePicAndApplyValue('/style/image/chest_normal.png','Regular Chest','measure_chest_ing','measure_chest')"><label>Regular Chest</label></li>
								<li><input type="radio" name="measure_chest" value="Husky/Hefty Chest" onclick="changePicAndApplyValue('/style/image/chest_husky_hefty.png','Husky/Hefty Chest','measure_chest_ing','measure_chest')"><label >Husky/Hefty Chest</label></li>
							</ul>
							<input id="measure_chest" type="hidden" name="measure_chest" checkRule="required" filedName="measure_shoulders" msg="please select a chest type!" msgField="measure_chest_noti">
				...
				<div class="measure_content">
					<div style="height: 300px;width: 400px;">
						<div class="attribute">
							...
							<input id="measure_stomach" type="hidden" name="measure_stomach" value="" checkRule="required" filedName="measure_shoulders" msg="please select a chest type!" msgField="measure_stomach_noti">
						...
						<div class="attribute">
							...
							<input id="measure_posture" type="hidden" name="measure_posture" value="" id="measure_posture" checkRule="required" filedName="measure_shoulders" msg="please select a posture type!" msgField="measure_posture_noti">
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" value=""  name="measure_shirt_neck" checkRule="required,double" filedName="Shirt Neck" msg="Shirt Neck must be a number!" msgField="measure_shirt_neck_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input"  value="" name="jacket_shirt_length" checkRule="required,double" filedName="Jacket/Shirt Length" msg="Shirt Neck must be a number!" msgField="jacket_shirt_length_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_chest_size" value="" checkRule="required,double" filedName="Chest Size" msg="Chest Size must be a number!" msgField="measure_chest_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_stomach_size" value="" checkRule="required,double" filedName="Stomach Size" msg="Stomach Size must be a number!" msgField="measure_stomach_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_jacket_hips" value="" checkRule="required,double" filedName="Jacket Hips" msg="Jacket Hips must be a number!" msgField="measure_jacket_hips_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_shoulder_size" value="" checkRule="required,double" filedName="Shoulder Size" msg="Shoulder Size must be a number!" msgField="measure_shoulder_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_sleeve_length"  value="" checkRule="required,double" filedName="Sleeve Length" msg="Sleeve Length must be a number!" msgField="measure_sleeve_length_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_bicep_size" value="" checkRule="required,double" filedName="Bicep Size" msg="Bicep Size must be a number!" msgField="measure_bicep_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_wrist_size" value="" checkRule="required,double" filedName="Wrist Size" msg="Wrist Size must be a number!" msgField="measure_wrist_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_pants_length"  value=""  checkRule="required,double" filedName="Pants Length" msg="Pants Length must be a number!" msgField="measure_pants_length_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_waist" value="" checkRule="required,double" filedName="Waist" msg="Waist must be a number!" msgField="measure_waist_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_crotch" value="" checkRule="required,double" filedName="Crotch" msg="Crotch must be a number!" msgField="measure_crotch_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_thigh_size" value="" checkRule="required,double" filedName="Thigh Size" msg="Thigh Size must be a number!" msgField="measure_thigh_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
			...
			<div class="measure_panel" style="display: none">
				...
				<div class="measure_field">
					<input type="text" class="measure_input" name="measure_knee_size" value=""  checkRule="required,double" filedName="Knee Size" msg="Knee Size must be a number!" msgField="measure_knee_size_noti"><SPAN style="font-size: 22px;font-weight: bold;">&nbsp;IN </SPAN>
	...
	<div>
		<input  type="text"  name="measure_height" class="txt_input" checkRule="required,double" filedName="height" msg="Hight must be a number!" msgField="xxxError">&nbsp;IN
