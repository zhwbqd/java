...
* readers can starve out the writer. * Note: The filename you provide will be overwritten. Substitute 
...
public class LockTest
{
    ...
    void doQueries(final FileChannel fc)
        throws Exception
    {
        while (true)
        {
    ...
    void doUpdates(final FileChannel fc)
        throws Exception
    {
        while (true)
        {
    ...
    private void updateIndex(final FileChannel fc)
        throws Exception
